...
const NAV_ITEMS = [
  ...
  { key: MENU_KEYS.CITAS, label: 'Citas', icon: CalendarToday,
    path: '/portal-crm/citas', section: 'operativo' },
  { key: MENU_KEYS.AGENDA, label: 'Agenda · horario', icon: EventAvailableIcon,
    path: '/portal-crm/agenda', section: 'operativo' },
