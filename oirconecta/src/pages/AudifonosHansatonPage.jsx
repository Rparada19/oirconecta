    ...
    <>
      ...
      <Box sx={{
        ...
        background:
          ...
          'linear-gradient(160deg, #3d6b63 0%, #71A095 35%, #1a2240 70%, #272F50 100%)',
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography component="h1" sx={{ fontSize: { xs: '2.5rem', md: '3.75rem' }, fontWeight: 900,
                ...
                Audífonos{' '}
                <Box component="span" sx={{ background: 'linear-gradient(135deg, #b2e4db 0%, #d4f0eb 100%)',
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: { xs: 5, md: 7 } }}>
            <Typography sx={{ fontWeight: 900, fontSize: { xs: '1.875rem', md: '2.75rem' },
              ...
              Línea de{' '}
              <Box component="span" sx={{ background: 'linear-gradient(135deg, #71A095 0%, #272F50 100%)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                productos
              </Box>
            </Typography>
      ...
      <Box sx={{ position: 'relative', overflow: 'hidden', py: { xs: 8, md: 12 },
        background:
          ...
          'linear-gradient(160deg, #3d6b63 0%, #71A095 40%, #1a2240 80%, #272F50 100%)',
        color: '#fff' }}>
