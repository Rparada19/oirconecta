    ...
    <>
      ...
      <Box sx={{
        ...
        background:
          ...
          'linear-gradient(160deg, #161c30 0%, #272F50 35%, #4a7a72 70%, #71A095 100%)',
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography component="h1" sx={{ fontSize: { xs: '2.5rem', md: '3.75rem' }, fontWeight: 900,
                ...
                Audífonos{' '}
                <Box component="span" sx={{ background: 'linear-gradient(135deg, #c8f5ed 0%, #d4d9f0 100%)',
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: { xs: 5, md: 7 } }}>
            <Typography sx={{ fontWeight: 900, fontSize: { xs: '1.875rem', md: '2.75rem' },
              ...
              Línea de{' '}
              <Box component="span" sx={{ background: 'linear-gradient(135deg, #272F50 0%, #71A095 100%)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                productos
              </Box>
            </Typography>
      ...
      <Box sx={{ position: 'relative', overflow: 'hidden', py: { xs: 5, md: 8 },
        background:
          ...
          'linear-gradient(160deg, #161c30 0%, #272F50 40%, #4a7a72 80%, #71A095 100%)',
        color: '#fff' }}>
