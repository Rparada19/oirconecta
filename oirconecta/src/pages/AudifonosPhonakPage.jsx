...
const BRAND = {
  ...
  rating: '4.9',
  gradient: 'linear-gradient(135deg, #008C45 0%, #00382B 100%)',
  glow: 'rgba(0,140,69,0.40)',
};
...
const tecnologias = [
  { icon: AutoAwesome, titulo: 'AutoSense Sky™', descripcion: 'Tecnología de reconocimiento automático de entornos', gradient: 'linear-gradient(135deg, #008C45 0%, #00382B 100%)' },
  ...
  { icon: Smartphone, titulo: 'App myPhonak', descripcion: 'Control personalizado desde tu móvil', gradient: 'linear-gradient(135deg, #008C45 0%, #00382B 100%)' },
];
  ...
  return (
    <>
      ...
      <Box sx={{
        ...
        background:
          'radial-gradient(ellipse 90% 70% at 10% 20%, rgba(0,140,69,0.42) 0%, transparent 55%),' +
          'radial-gradient(ellipse 70% 60% at 90% 80%, rgba(39,47,80,0.55) 0%, transparent 55%),' +
          'linear-gradient(160deg, #00382B 0%, #005c30 30%, #00382B 70%, #1a1f38 100%)',
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography component="h1" sx={{ fontSize: { xs: '2.5rem', md: '3.75rem' }, fontWeight: 900,
                ...
                Audífonos{' '}
                <Box component="span" sx={{ background: 'linear-gradient(135deg, #008C45 0%, #00382B 100%)',
            ...
            {productos.map((p, i) => (
              <Grid item xs={12} sm={6} md={4} key={i}>
                <Box sx={{ height: '100%', borderRadius: '22px', overflow: 'hidden', bgcolor: '#fff',
                  boxShadow: '0 2px 20px rgba(0,140,69,0.08)', border: '1px solid rgba(0,140,69,0.08)',
                  display: 'flex', flexDirection: 'column',
                  transition: 'all 0.28s ease',
                  '&:hover': { transform: 'translateY(-6px)', boxShadow: '0 20px 48px rgba(0,140,69,0.15)' },
                  position: 'relative',
                }}>
                  {p.destacado && (
                    <Box sx={{ position: 'absolute', top: 12, right: 12, zIndex: 2,
                      ...
                      boxShadow: '0 4px 12px rgba(0,140,69,0.35)' }}>
                  ...
                  <Box sx={{ p: 2.5, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1.5 }}>
                      <Chip label={p.categoria} size="small" sx={{ fontWeight: 700, fontSize: '0.7rem',
                        bgcolor: 'rgba(0,140,69,0.08)', color: '#008C45', border: '1px solid rgba(0,140,69,0.18)' }} />
                    </Box>
                    ...
                    <Button variant="contained" fullWidth onClick={() => navigate('/agendar')}
                      sx={{ borderRadius: '12px', fontWeight: 700,
                        ...
                        '&:hover': { boxShadow: '0 6px 20px rgba(0,140,69,0.35)' } }}>
              ...
              return (
                <Grid item xs={12} sm={6} md={3} key={t.titulo}>
                  <Box sx={{ borderRadius: '22px', p: 3, height: '100%', textAlign: 'center',
                    ...
                    border: '1px solid rgba(0,140,69,0.08)', boxShadow: '0 2px 16px rgba(0,140,69,0.07)',
                    transition: 'all 0.28s ease',
                    '&:hover': { transform: 'translateY(-6px)', boxShadow: '0 20px 48px rgba(0,140,69,0.14)' } }}>
                    <Box sx={{ width: 64, height: 64, borderRadius: '8px', background: t.gradient,
                      display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 2,
                      boxShadow: '0 8px 20px rgba(0,140,69,0.25)' }}>
      ...
      <Box sx={{ position: 'relative', overflow: 'hidden', py: { xs: 5, md: 8 },
        background:
          'radial-gradient(ellipse 80% 60% at 20% 50%, rgba(0,140,69,0.65) 0%, transparent 55%),' +
