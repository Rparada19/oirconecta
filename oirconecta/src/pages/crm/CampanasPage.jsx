          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 2 }}>
            <Box sx={{ minWidth: 0, flex: '1 1 240px', maxWidth: '100%' }}>
              ...
              <Typography variant="body2" sx={{ opacity: 0.9, wordBreak: 'break-word', overflowWrap: 'anywhere' }}>
                Administración CRM: campañas por marca, vigencias, cotizaciones y ventas asociadas.
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', flexShrink: 0 }}>
              ...
              <Button
                ...
                sx={{ borderColor: '#ffffff', color: '#ffffff', '&:hover': { borderColor: '#ffffff', bgcolor: 'rgba(255, 255, 255, 0.1)' } }}
              >
                Volver
              </Button>
            </Box>
