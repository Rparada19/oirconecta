  ...
  return (
    <>
      ...
      <Box sx={{
        ...
        background:
          'radial-gradient(ellipse 90% 70% at 10% 20%, rgba(10,77,60,0.55) 0%, transparent 55%),' +
          'radial-gradient(ellipse 70% 60% at 90% 80%, rgba(113,160,149,0.35) 0%, transparent 55%),' +
          'linear-gradient(160deg, #051f18 0%, #0a4d3c 35%, #0d6b52 70%, #71A095 100%)',
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography component="h1" sx={{ fontSize: { xs: '2.5rem', md: '3.75rem' }, fontWeight: 900,
                ...
                Audífonos{' '}
                <Box component="span" sx={{ background: 'linear-gradient(135deg, #6ee7c8 0%, #b2f5ea 100%)',
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: { xs: 5, md: 7 } }}>
            <Typography sx={{ fontWeight: 900, fontSize: { xs: '1.875rem', md: '2.75rem' },
              ...
              Línea de{' '}
              <Box component="span" sx={{ background: 'linear-gradient(135deg, #0a4d3c 0%, #71A095 100%)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                productos
              </Box>
            </Typography>
      ...
      <Box sx={{ position: 'relative', overflow: 'hidden', py: { xs: 5, md: 8 },
        background:
          ...
          'linear-gradient(160deg, #051f18 0%, #0a4d3c 40%, #0d6b52 80%, #71A095 100%)',
        color: '#fff' }}>
