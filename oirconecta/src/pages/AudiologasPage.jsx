          ...
          <Box sx={{
            ...
            <Box sx={{ pb: { md: 1.5 } }}>
              <Typography sx={{
                ...
                Especialistas certificadas en audiología y fonoaudiología, verificadas y con perfil público para el cuidado de tu salud auditiva.
              </Typography>
              <Stack direction="row" spacing={3} divider={<Box sx={{ width: 1, bgcolor: 'rgba(39,47,80,0.15)' }} />}>
                {[
                  { num: audiologas.length, label: 'Profesionales' },
                  { num: [...new Set(audiologas.map(a => a.ciudad).filter(Boolean))].length, label: 'Ciudades' },
