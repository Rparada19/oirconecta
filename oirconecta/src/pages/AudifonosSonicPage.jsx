...
const BRAND = {
  ...
  rating: '4.7',
  gradient: 'linear-gradient(135deg, #2D2D2D 0%, #272F50 100%)',
  glow: 'rgba(45,45,45,0.40)',
};

const productos = [
  { nombre: 'Sonic Trek', categoria: 'RIC', descripcion: 'Audífono con tecnología SoundDNA™, recargable y control total desde la app.', caracteristicas: ['Tecnología SoundDNA™', 'Bluetooth y recargable', 'App SoundLink 2', 'Resistente al agua'], destacado: true },
  { nombre: 'Sonic Cheer', categoria: 'BTE', descripcion: 'Sonido natural y claro con diseño elegante y discreto.', caracteristicas: ['Sonido natural y claro', 'Recargable', 'App SoundLink 2', 'Diseño elegante y discreto'], destacado: false },
  { nombre: 'Sonic Ion', categoria: 'ITE', descripcion: 'Diseño personalizado, conectividad avanzada y sonido potente.', caracteristicas: ['Diseño personalizado', 'Conectividad avanzada', 'App SoundLink 2', 'Sonido potente y natural'], destacado: false },
];

const tecnologias = [
  { icon: Hearing, titulo: 'SoundDNA™', descripcion: 'Tecnología de procesamiento de sonido natural sin distorsión', gradient: 'linear-gradient(135deg, #2D2D2D 0%, #272F50 100%)' },
  ...
  { icon: BatteryChargingFull, titulo: 'Recargable', descripcion: 'Batería recargable y resistente al agua IP68', gradient: 'linear-gradient(135deg, #2D2D2D 0%, #272F50 100%)' },
  { icon: Smartphone, titulo: 'App SoundLink 2', descripcion: 'Control total de los audífonos desde tu móvil', gradient: 'linear-gradient(135deg, #2D2D2D 0%, #272F50 100%)' },
];

const AudifonosSonicPage = () => {
  const navigate = useNavigate();
  return (
    <>
      <Helmet>
        <title>Audífonos Sonic - OírConecta | Speech Variable Processing™</title>
        <meta name="description" content="Descubre los audífonos Sonic con tecnología SoundDNA™. Trek, Cheer y Ion con conectividad Bluetooth y app SoundLink 2." />
        <link rel="canonical" href="https://oirconecta.com/audifonos/sonic" />
      </Helmet>
      <Header />
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ display: 'inline-flex', alignItems: 'center', px: 2.5, py: 1.5,
                ...
                <img src={BRAND.logo} alt="Sonic" style={{ height: 48, objectFit: 'contain' }} />
              </Box>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                <Button variant="contained" size="large" endIcon={<ArrowForward />}
                  onClick={() => navigate('/contacto?asunto=Solicitud%20de%20información%20-%20Sonic')}
              ...
              <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                <Box sx={{ borderRadius: '8px', overflow: 'hidden', width: '100%', maxWidth: 440,
                  ...
                  <Box sx={{ borderRadius: '8px', bgcolor: '#fff', p: 3, mb: 3, textAlign: 'center' }}>
                    <img src={BRAND.logo} alt="Sonic" style={{ height: 80, objectFit: 'contain' }} />
                  </Box>
                  {/* Stats */}
              ...
              <Grid item xs={12} sm={6} md={4} key={i}>
                <Box sx={{ height: '100%', borderRadius: '22px', overflow: 'hidden', bgcolor: '#fff',
                  ...
                  <Box sx={{ p: 2.5, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Button variant="contained" fullWidth onClick={() => navigate('/contacto?asunto=Solicitud%20de%20información%20-%20Sonic')}
      ...
      <Box sx={{ position: 'relative', overflow: 'hidden', py: { xs: 5, md: 8 },
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <Typography sx={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.78)', mb: 5, maxWidth: 500, mx: 'auto', lineHeight: 1.65 }}>
            Un especialista de la red te orienta sobre los modelos Sonic que mejor se adaptan a tu caso.
          </Typography>
...
export default AudifonosSonicPage;
