...
// Imágenes de ejemplo para Sonic
const sonicLogo = '/logos/marcas/Sonic-logo.png';
const heroImg = 'https://www.sonici.com/-/media/sonic/main/products/trek/trek-hero.jpg';
const sonicProduct1 = 'https://www.sonici.com/-/media/sonic/main/products/trek/trek-product.png';
const sonicProduct2 = 'https://www.sonici.com/-/media/sonic/main/products/cheer/cheer-product.png';
const sonicProduct3 = 'https://www.sonici.com/-/media/sonic/main/products/ion/ion-product.png';

const productos = [
  {
    nombre: 'Sonic Trek',
    imagen: sonicProduct1,
    categoria: 'RIC',
    caracteristicas: [
      'Tecnología SoundDNA™',
      'Recargable y resistente al agua',
      'Conectividad Bluetooth',
      'App Sonic SoundLink 2'
    ],
    tamanos: 'Mini, Estándar',
    tecnologias: 'Trek, Bluetooth, Recargable',
  },
  {
    nombre: 'Sonic Cheer',
    imagen: sonicProduct2,
    categoria: 'BTE',
    caracteristicas: [
    ...
    tamanos: 'Mini, Estándar',
    tecnologias: 'Cheer, Recargable, App',
  },
  {
    nombre: 'Sonic Ion',
    imagen: sonicProduct3,
    categoria: 'ITE',
    caracteristicas: [
...
const categorias = [
  {
    ...
    imagen: sonicProduct1,
    cta: 'Descubra',
    url: 'https://www.sonici.com/es-es/productos'
  },
  {
    nombre: 'BTE',
...
const modelos = [
  {
    nombre: 'Sonic Trek',
    descripcion: 'Audífono con tecnología SoundDNA™, recargable y control total desde la app.',
    imagen: sonicProduct1,
    url: 'https://www.sonici.com/es-es/productos/trek'
  },
  {
    nombre: 'Sonic Cheer',
    descripcion: 'Sonido natural y claro con diseño elegante y discreto.',
    imagen: sonicProduct2,
    url: 'https://www.sonici.com/es-es/productos/cheer'
  },
  {
    nombre: 'Sonic Ion',
    descripcion: 'Diseño personalizado, conectividad avanzada y sonido potente.',
    imagen: sonicProduct3,
    url: 'https://www.sonici.com/es-es/productos/ion'
  }
];

const beneficios = [
  'Tecnología SoundDNA™ para mejor audición.',
  'Recargables y resistentes al agua.',
  'Conectividad Bluetooth y app SoundLink 2.',
  'Soluciones personalizadas y discretas.',
  'Sonido natural y claro en cualquier ambiente.',
  'App SoundLink 2 para control total.',
  'Diseño elegante y discreto.',
  'Compatibilidad con accesorios Sonic.'
];

const accesorios = [
  {
    nombre: 'Sonic TV Adapter',
    descripcion: 'Transmite el sonido de la TV directamente a los audífonos.',
    icono: '📺',
    url: '/contacto'
  },
  {
    nombre: 'Sonic Remote Control',
    descripcion: 'Control remoto para ajustar los audífonos.',
    icono: '🎛️',
    url: '/contacto'
  },
  {
    nombre: 'App SoundLink 2',
...
const accesoriosDetallados = [
  {
    nombre: 'Cargador Sonic',
    descripcion: 'Cargador rápido y elegante para audífonos recargables Sonic.',
    icono: '🔋',
    url: '/contacto'
  },
  {
  ...
  },
  {
    ...
    descripcion: 'Pilas y repuestos originales Sonic.',
    icono: '🔋',
    url: '/contacto'
  }
];

export default function AudifonosSonicPage() {
        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{
            ...
            <Box sx={{ flex: 1, minWidth: 300 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                <img src={sonicLogo} alt="Sonic Logo" style={{ height: 60, marginRight: 18 }} />
                <Typography variant="h3" fontWeight={800} color="#272F50" sx={{ letterSpacing: -1 }}>
                  Descubre Sonic en Oir Conecta
                </Typography>
              </Box>
              <Typography variant="h5" color="#272F50" mb={3} fontWeight={400}>
                Audífonos con tecnología SoundDNA™, recargables y conectividad total para una experiencia auditiva personalizada.
              </Typography>
              <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 3 }}>
                ...
                <Typography color="#272F50">Sonic</Typography>
              </Breadcrumbs>
              <Button variant="contained" size="large" sx={{ mt: 1, px: 5, py: 1.5, fontWeight: 700, fontSize: 18, borderRadius: 3, bgcolor: '#0A68B0', boxShadow: '0 2px 8px rgba(8,89,70,0.10)' }} href="#formulario">
                Solicitar Información
              </Button>
            </Box>
            <Box sx={{ flex: 1, minWidth: 320, display: 'flex', justifyContent: 'center' }}>
              <img src={heroImg} alt="Audífono Sonic principal" style={{ width: '100%', maxWidth: 420, borderRadius: 32, boxShadow: '0 8px 32px rgba(8,89,70,0.10)' }} />
            </Box>
          </Box>
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            <Typography variant="h2" fontWeight={800} color="#272F50" mb={2}>
              Audición inteligente con Sonic
            </Typography>
            <Typography variant="h5" color="#085946" mb={2}>
              Sonic integra tecnología SoundDNA™, conectividad y diseño para que vivas cada momento con claridad y confianza.
            </Typography>
            <Typography variant="h6" color="#272F50" fontWeight={600}>
              Trek, Cheer y app SoundLink 2 para cada necesidad auditiva.
            </Typography>
          </Box>
              ...
              {categorias.map((cat, idx) => (
                <Grid item xs={12} sm={6} md={4} key={idx}>
                  <Card sx={{ borderRadius: 6, boxShadow: '0 4px 24px rgba(8,89,70,0.10)', p: 2, bgcolor: '#fff', minHeight: 340, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Button variant="outlined" href={cat.url} target="_blank" sx={{ borderColor: '#0A68B0', color: '#0A68B0', fontWeight: 600, borderRadius: 2 }}>{cat.cta}</Button>
                  </Card>
                </Grid>
              ))}
            </Grid>
              ...
              {modelos.map((mod, idx) => (
                <Grid item xs={12} sm={6} md={4} key={idx}>
                  <Card sx={{ borderRadius: 6, boxShadow: '0 4px 24px rgba(8,89,70,0.10)', p: 2, bgcolor: '#fff', minHeight: 340, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Button variant="outlined" href={mod.url} target="_blank" sx={{ borderColor: '#0A68B0', color: '#0A68B0', fontWeight: 600, borderRadius: 2 }}>Ver más</Button>
                  </Card>
                </Grid>
              ))}
            </Grid>
          ...
          <Box sx={{ mb: 8, p: { xs: 2, md: 4 }, borderRadius: 6, bgcolor: '#fff', boxShadow: '0 2px 16px rgba(8,89,70,0.06)' }}>
            <Typography variant="h4" fontWeight={700} color="#272F50" mb={4} textAlign="center">
              Beneficios y tecnologías Sonic
            </Typography>
            <Box
              sx={{
                display: 'flex',
          ...
          <Box sx={{ mb: 8 }}>
            <Typography variant="h4" fontWeight={700} color="#272F50" mb={4} textAlign="center">
              Accesorios y aplicaciones Sonic
            </Typography>
            <Grid container spacing={4} justifyContent="center">
              {accesorios.map((acc, idx) => (
                <Grid item xs={12} sm={6} md={4} key={idx}>
                  <Card sx={{ borderRadius: 6, boxShadow: '0 4px 24px rgba(8,89,70,0.10)', p: 2, bgcolor: '#fff', minHeight: 180, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Button variant="outlined" href={acc.url} sx={{ borderColor: '#0A68B0', color: '#0A68B0', fontWeight: 600, borderRadius: 2 }}>Más información</Button>
                  </Card>
                </Grid>
              ))}
            </Grid>
          ...
          {/* ACCESORIOS DETALLADOS SONIC */}
          <Box sx={{ mb: 8 }}>
            <Typography variant="h4" fontWeight={700} color="#272F50" mb={4} textAlign="center">
              Accesorios oficiales Sonic
            </Typography>
            <Grid container spacing={4} justifyContent="center">
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            <Button variant="contained" size="large" href="https://www.sonici.com/es-es/prueba-auditiva" target="_blank" sx={{ bgcolor: '#0A68B0', px: 6, py: 2, fontWeight: 700, fontSize: 20, borderRadius: 3, boxShadow: '0 2px 8px rgba(8,89,70,0.10)' }}>
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            ...
            <Button variant="text" href="https://www.sonici.com/es-es/productos" target="_blank" sx={{ color: '#0A68B0', fontWeight: 600, fontSize: 16 }}>
              Página oficial de audífonos Sonic
            </Button>
          </Box>
          ...
          <Box id="formulario" sx={{ mb: 8, p: { xs: 2, md: 4 }, borderRadius: 6, bgcolor: '#fff', boxShadow: '0 2px 16px rgba(8,89,70,0.06)' }}>
            <Typography variant="h4" fontWeight={700} color="#272F50" mb={4} textAlign="center">
              Solicitar información sobre Sonic
            </Typography>
            <Box component="form" sx={{ maxWidth: 600, mx: 'auto', p: 3 }}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Button variant="contained" color="primary" size="large" sx={{ bgcolor: '#0A68B0', borderRadius: 3, fontWeight: 700, fontSize: 18, px: 5, py: 1.5 }}>
                    Enviar solicitud
                  </Button>
                </Grid>
              </Grid>
