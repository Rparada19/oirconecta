...
const BRAND = {
  ...
  rating: '4.7',
  gradient: 'linear-gradient(135deg, #6E2585 0%, #272F50 100%)',
  glow: 'rgba(110,37,133,0.40)',
};
...
const tecnologias = [
  { icon: Psychology, titulo: 'BrainHearing™', descripcion: 'Tecnología que imita el procesamiento natural del cerebro', gradient: 'linear-gradient(135deg, #6E2585 0%, #272F50 100%)' },
  ...
  return (
    <>
      ...
      <Box sx={{
        ...
        background:
          'radial-gradient(ellipse 90% 70% at 10% 20%, rgba(110,37,133,0.42) 0%, transparent 55%),' +
          'radial-gradient(ellipse 70% 60% at 90% 80%, rgba(39,47,80,0.55) 0%, transparent 55%),' +
          'linear-gradient(160deg, #3a134a 0%, #5a2070 30%, #272F50 70%, #1a1f38 100%)',
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography sx={{ fontSize: '1.25rem', fontWeight: 700, color: '#d8b4fe', mb: 2.5, letterSpacing: '-0.01em' }}>
                {BRAND.eslogan}
              </Typography>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                <Button variant="contained" size="large" endIcon={<ArrowForward />}
                  onClick={() => navigate('/contacto?asunto=Solicitud%20de%20información%20-%20Oticon')}
                    ...
                    {[
                      ...
                      <Grid item xs={6} key={s.label}>
                        <Box sx={{ borderRadius: '14px', p: 2, background: 'rgba(255,255,255,0.10)',
                          ...
                          <Typography sx={{ fontWeight: 900, fontSize: '1.5rem', color: '#d8b4fe', letterSpacing: '-0.02em' }}>{s.value}</Typography>
              ...
              <Grid item xs={12} sm={6} md={4} key={i}>
                <Box sx={{ height: '100%', borderRadius: '22px', overflow: 'hidden', bgcolor: '#fff',
                  ...
                  <Box sx={{ p: 2.5, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Button variant="contained" fullWidth onClick={() => navigate('/contacto?asunto=Solicitud%20de%20información%20-%20Oticon')}
...
export default AudifonosOticonPage;
