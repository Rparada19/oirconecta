...
// Imágenes
const advancedBionicsLogo = '/logos/marcas/Advanced-Bionics-logo.png';
...
const ImplantesAdvancedBionicsPage = () => {
  const productos = [
    {
      ...
      descripcion: 'El implante coclear más avanzado de Advanced Bionics',
      caracteristicas: [
        'Tecnología UltraZoom™',
        'Conectividad Bluetooth',
        'Batería de larga duración',
        'App AB MyLink'
      ],
      tecnologias: ['UltraZoom™', 'Bluetooth', 'AI Learning'],
      precio: 'Desde $14.800.000'
    },
    {
      nombre: 'Naida CI M90™',
      categoria: 'Implante Coclear',
      ...
      tecnologias: ['UltraZoom™', 'Bluetooth', 'Voice Control'],
      precio: 'Desde $13.900.000'
    },
    {
      nombre: 'Naida CI Q30™',
      categoria: 'Implante Coclear',
  ...
  return (
    <>
      <Helmet>
        <title>Implantes Cocleares Advanced Bionics - OirConecta | Tecnología UltraZoom™</title>
        <meta name="description" content="Descubre los implantes cocleares Advanced Bionics con tecnología UltraZoom™. Naida CI Q90, M90 y Q30 con conectividad Bluetooth." />
        <meta name="keywords" content="implante coclear advanced bionics, ultra zoom, naida ci q90, naida ci m90, naida ci q30, Colombia" />
              ...
              <Fade in timeout={500}>
                <Box>
                  <Breadcrumbs sx={{ mb: 4, color: '#666' }}>
                    ...
                    <Typography color="text.primary">Advanced Bionics</Typography>
                  </Breadcrumbs>
                  
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
                    <img 
                      src={advancedBionicsLogo} 
                  ...
                  <Typography variant="body1" sx={{ mb: 4, color: '#666', lineHeight: 1.6, fontSize: '1.1rem' }}>
                    Innovación en tecnología de implantes cocleares con más de 25 años de experiencia. 
      ...
      <Box sx={{ py: 8, background: '#f8f9fa', borderTop: '1px solid #e0e0e0' }}>
        <Container maxWidth="md" sx={{ textAlign: 'center' }}>
          ...
          <Typography variant="body1" sx={{ mb: 4, color: '#666', fontSize: '1.1rem' }}>
            Agenda una consulta gratuita y descubre cómo Advanced Bionics puede transformar tu audición
          </Typography>
          <Button
            variant="contained"
            size="large"
