...
const BRAND = {
  nombre: 'ReSound',
  logo: '/logos/marcas/Resound-logo.png.webp',
...
const productos = [
  {
    ...
    caracteristicas: ['Tecnología M&RIE para sonido natural', 'Recargable y resistente al agua', 'Conectividad Bluetooth', 'App ReSound Smart 3D'],
    destacado: true,
  },
  {
    ...
    caracteristicas: ['Sonido claro y brillante', 'Recargable', 'Conectividad avanzada', 'App ReSound Smart 3D'],
    destacado: false,
  },
  {
    ...
    caracteristicas: ['Potencia para pérdidas severas', 'Sonido natural y potente', 'Bluetooth y app', 'Recargable y robusto'],
    destacado: false,
  },
];

const tecnologias = [
  { icon: Hearing, titulo: 'M&RIE', descripcion: 'Micrófono en el oído para sonido natural y personalizado', gradient: 'linear-gradient(135deg, #C9342B 0%, #272F50 100%)' },
  { icon: Bluetooth, titulo: 'Conectividad Total', descripcion: 'Bluetooth y streaming directo con todos los dispositivos', gradient: 'linear-gradient(135deg, #C9342B 0%, #272F50 100%)' },
  ...
  { icon: Smartphone, titulo: 'Smart 3D App', descripcion: 'Control total de los audífonos desde tu móvil', gradient: 'linear-gradient(135deg, #C9342B 0%, #272F50 100%)' },
];

const AudifonosResoundPage = () => {
  const navigate = useNavigate();
  return (
    <>
      <Helmet>
        <title>Audífonos ReSound - OírConecta | Smart Hearing™</title>
        <meta name="description" content="Descubre los audífonos ReSound con tecnología M&RIE y Smart Hearing™. ReSound ONE, LiNX Quattro y ENZO Q con conectividad Bluetooth y app Smart 3D." />
        <link rel="canonical" href="https://oirconecta.com/audifonos/resound" />
      </Helmet>
      <Header />
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ display: 'inline-flex', alignItems: 'center', px: 2.5, py: 1.5,
                ...
                <img src={BRAND.logo} alt="ReSound" style={{ height: 48, objectFit: 'contain' }} />
              </Box>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                <Button variant="contained" size="large" endIcon={<ArrowForward />}
                  onClick={() => navigate('/contacto?asunto=Solicitud%20de%20información%20-%20Resound')}
              ...
              <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                <Box sx={{ borderRadius: '8px', overflow: 'hidden', width: '100%', maxWidth: 440,
                  ...
                  <Box sx={{ borderRadius: '8px', bgcolor: '#fff', p: 3, mb: 3, textAlign: 'center' }}>
                    <img src={BRAND.logo} alt="ReSound" style={{ height: 80, objectFit: 'contain' }} />
                  </Box>
                  {/* Stats */}
              ...
              <Grid item xs={12} sm={6} md={4} key={i}>
                <Box sx={{ height: '100%', borderRadius: '22px', overflow: 'hidden', bgcolor: '#fff',
                  ...
                  <Box sx={{ p: 2.5, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Button variant="contained" fullWidth onClick={() => navigate('/contacto?asunto=Solicitud%20de%20información%20-%20Resound')}
      ...
      <Box sx={{ position: 'relative', overflow: 'hidden', py: { xs: 5, md: 8 },
        background:
          'radial-gradient(ellipse 80% 60% at 20% 50%, rgba(8,89,70,0.40) 0%, transparent 55%),' +
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <Typography sx={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.78)', mb: 5, maxWidth: 500, mx: 'auto', lineHeight: 1.65 }}>
            Un especialista de la red te orienta sobre los modelos ReSound que mejor se adaptan a tu caso.
          </Typography>
...
export default AudifonosResoundPage;
