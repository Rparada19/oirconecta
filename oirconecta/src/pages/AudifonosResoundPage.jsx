  ...
  return (
    <>
      ...
      <Box sx={{
        ...
        background:
          'radial-gradient(ellipse 90% 70% at 10% 20%, rgba(8,89,70,0.45) 0%, transparent 55%),' +
          'radial-gradient(ellipse 70% 60% at 90% 80%, rgba(39,47,80,0.55) 0%, transparent 55%),' +
          'linear-gradient(160deg, #042e1e 0%, #085946 35%, #1a2240 70%, #272F50 100%)',
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: { xs: 5, md: 7 } }}>
            <Typography sx={{ fontWeight: 900, fontSize: { xs: '1.875rem', md: '2.75rem' },
              ...
              Línea de{' '}
              <Box component="span" sx={{ background: 'linear-gradient(135deg, #085946 0%, #272F50 100%)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                productos
              </Box>
            </Typography>
      ...
      <Box sx={{ position: 'relative', overflow: 'hidden', py: { xs: 5, md: 8 },
        background:
          ...
          'linear-gradient(160deg, #042e1e 0%, #085946 40%, #1a2240 80%, #272F50 100%)',
        color: '#fff' }}>
