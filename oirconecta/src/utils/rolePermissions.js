...
const MENU_BY_ROLE = {
  [ROLES.ADMIN]: [MENU_KEYS.DASHBOARD, MENU_KEYS.ACCIONES_DIA, MENU_KEYS.CITAS, MENU_KEYS.AGENDA, MENU_KEYS.LEADS, MENU_KEYS.PACIENTES, MENU_KEYS.CONTROLES, MENU_KEYS.OPORTUNIDADES, MENU_KEYS.WHATSAPP, MENU_KEYS.CAMPANAS, MENU_KEYS.PLANTILLAS, MENU_KEYS.REPORTES, MENU_KEYS.FINANZAS, MENU_KEYS.AUTOMATIZACIONES, MENU_KEYS.PRODUCTOS, MENU_KEYS.CONFIGURACION],
  [ROLES.RECEPCION]: [MENU_KEYS.DASHBOARD, MENU_KEYS.ACCIONES_DIA, MENU_KEYS.CITAS, MENU_KEYS.AGENDA, MENU_KEYS.LEADS, MENU_KEYS.PACIENTES, MENU_KEYS.CONTROLES, MENU_KEYS.OPORTUNIDADES, MENU_KEYS.WHATSAPP, MENU_KEYS.REPORTES],
  [ROLES.AUDIOLOGA]: [MENU_KEYS.DASHBOARD, MENU_KEYS.ACCIONES_DIA, MENU_KEYS.CITAS, MENU_KEYS.AGENDA, MENU_KEYS.LEADS, MENU_KEYS.PACIENTES, MENU_KEYS.CONTROLES, MENU_KEYS.OPORTUNIDADES, MENU_KEYS.WHATSAPP, MENU_KEYS.REPORTES],
  [ROLES.VENDEDOR]: [MENU_KEYS.DASHBOARD, MENU_KEYS.ACCIONES_DIA, MENU_KEYS.CITAS, MENU_KEYS.AGENDA, MENU_KEYS.LEADS, MENU_KEYS.PACIENTES, MENU_KEYS.CONTROLES, MENU_KEYS.OPORTUNIDADES, MENU_KEYS.WHATSAPP, MENU_KEYS.REPORTES],
  [ROLES.SOLO_LECTURA]: [MENU_KEYS.DASHBOARD, MENU_KEYS.ACCIONES_DIA, MENU_KEYS.CITAS, MENU_KEYS.AGENDA, MENU_KEYS.LEADS, MENU_KEYS.PACIENTES, MENU_KEYS.CONTROLES, MENU_KEYS.OPORTUNIDADES, MENU_KEYS.WHATSAPP, MENU_KEYS.REPORTES],
