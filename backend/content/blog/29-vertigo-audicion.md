---
slug: vertigo-audicion
titulo: "Vértigo y audición: cuando el problema no es solo el equilibrio"
resumen: "El oído interno controla equilibrio y audición. Cuando hay vértigo, mirar la audición da pistas clave del diagnóstico."
categoria: guias
tags:
  - vértigo
  - oído interno
...
1. Pide audiometría junto con la valoración vestibular.
2. Anota si el vértigo dura segundos, minutos u horas: es el dato más útil para el diagnóstico.
3. Si hay pérdida auditiva súbita asociada, urgencias el mismo día.
4. El tratamiento depende del diagnóstico, no del síntoma: no todos los vértigos son iguales.
