...
const COVERS = {
  ...
  'adaptacion-audifonos-primeras-semanas':  P(36670377),
  'tinnitus-zumbido-oido':                  P(6319017),
  'perdida-auditiva-subita':                U('1631558556874-1d127211f574'),
  'higiene-del-oido':                       P(5206946),
  'presbiacusia':                           P(36485822),
  'limpieza-diaria-audifonos':              P(36670377),
  'baterias-vs-recargables-audifonos':      U('1606811971618-4486d14f3f99'),
  'humedad-secado-audifonos':               P(36485822),
  'audifonos-deporte-sudor':                P(6293191),
  'vida-util-audifono':                     P(14682242),
  'audifono-mojado-que-hacer':              P(36670377),
  ...
  'problemas-audifono-soluciones-rapidas':  P(36485822),
  'guia-elegir-primer-audifono':            U('1554224155-1696413565d3'),
  'que-es-la-audiometria':                  P(5206951),
  'vida-con-hipoacusia-consejos':           U('1559757175-5700dde675bc'),
  'audifonos-recargables-vs-pilas':         U('1606811971618-4486d14f3f99'),
